<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            ...
            <a-form-item label="工单流程">
              <a-select v-model="queryParam.processName" style="width: 100%" placeholder="请选择工单流程">
    ...
    <!-- 条形图 -->
    <line-chart-multid style="width:80%;margin-top:60px" title="流程统计报表" :fields="fields" :height="420"
                       :dataSource="dataA"/>
  ...
  export default {
    ...
    data() {
      return {
        ...
        fields: [],
        dataA: [],
        typeList: [{ procName: '巡检流程', desformCode: 'patrol' }, { procName: '报修流程', desformCode: 'repairo' }],
        years: [],
        months: [{ name: '全部', month: '0' }, { name: '1月', month: '1' }, { name: '2月', month: '2' }, {
          name: '3月',
          month: '3'
          ...
          { name: '7月', month: '7' }, { name: '8月', month: '8' }, { name: '9月', month: '9' }, {
            name: '10月',
            month: '10'
          }, { name: '11月', month: '11' }, { name: '12月', month: '12' }],
        description: '流程统计',
        // 表头
        url: {
          list: '/cascade/patrol/getStatusTable'
        },
    ...
    methods: {
      ...
      getYears() {
        ...
        for (let index = (yy - 10); index <= yy; index++) {
      ...
      searchReset() {
        ...
        this.queryParam.code = 'patrol'
        this.queryParam.processName = '巡检流程'
