  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          ...
          searchQuery: 'cascade/repairo/searchQuery'
        },
        dictOptions: {},
        courtNames: [],
        fieldList: [],
    ...
    methods: {
      ...
      searchQuery() {
        ...
        if (this.queryParam.fymc != '' && this.queryParam.fymc) {
        ...
        getAction(this.url.columns, {
          ...
          if (res.success) {
            ...
            for (let i = 0; i < this.columnList.length; i++) {
              ...
              if (name != 'fybm' && name != 'gs' && name != 'lczt' && name != 'fymc' && name != 'xjxq' && name != 'bxms' && name != 'jjfajs') {
