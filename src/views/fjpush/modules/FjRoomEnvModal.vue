  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/fjpush/fjRoomEnv/add",
          edit: "/fjpush/fjRoomEnv/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'createTime','updateTime','orgCode','rmCode','envHealthValue','powerHealthValue','electrRealPower','upsRealPower','roomAverTemp','roomAverHum','waterLeakStatus','fireStatus'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'createTime','updateTime','orgCode','rmCode','envHealthValue','powerHealthValue','electrRealPower','upsRealPower','roomAverTemp','roomAverHum','waterLeakStatus','fireStatus'))
      },
