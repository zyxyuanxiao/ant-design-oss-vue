<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator"
      ...
      <a-button @click="handleSyncUser"
                v-has="'user:syncbpm'"
                type="primary"
                icon="plus">同步流程</a-button>
      <a-button type="primary"
                icon="download"
                @click="handleExportXls('用户信息')">导出</a-button>
      <a-upload name="file"
        ...
        <span slot="action"
          ...
          <a-dropdown>
            ...
            <a-menu slot="overlay">
              ...
              <a-menu-item>
                <a href="javascript:;"
                   @click="handleAgentSettings(record.username)">代理人</a>
              </a-menu-item>
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        ...
        synUyunUser: "sys/user/synUyunUser"
      },
    }
  },
  computed: {
  ...
  methods: {
    ...
    synUyun () {
      getAction(this.url.synUyunUser).then((res) => {
        if (res.success) {
