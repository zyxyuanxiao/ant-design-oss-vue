    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="网络域" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['domain']" placeholder="请输入网络域"></a-input>
        </a-form-item>
        ...
        <a-form-item label="网段描述" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['networkDesc']" placeholder="请输入网段描述"></a-input>
        </a-form-item>
        ...
        <a-form-item label="厂商" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['manufactor']" placeholder="请输入厂商"></a-input>
        </a-form-item>
