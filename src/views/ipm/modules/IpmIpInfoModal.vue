    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="分配状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="radio" v-decorator="['usestatus', validatorRules.usestatus]" :trigger-change="true"
                             dictCode="useStatus" placeholder="请选择分配状态"/>
        </a-form-item>
          </a-col>
        </a-row>
        <a-row class="form-row" :gutter="0">
        ...
        <a-form-item label="在线状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="radio" v-decorator="['onlineStatus', validatorRules.onlineStatus]"
                             :trigger-change="true" dictCode="onlineStatus" placeholder="请选择在线状态"/>
        </a-form-item>
          </a-col>
          <a-col :lg="12">
        <a-form-item label="入网时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择入网时间" v-decorator="['createTime', validatorRules.createTime]" :trigger-change="true"
        ...
        <a-form-item label="上一次在线时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择上一次在线时间" v-decorator="['lastOnlineTime']" :trigger-change="true" :show-time="true"
                  date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%"/>
        </a-form-item>
          </a-col>
          <a-col :lg="12">
        <a-form-item label="检测时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择检测时间" v-decorator="['checkedTime']" :trigger-change="true" :show-time="true"
                  date-format="YYYY-MM-DD HH:mm:ss" style="width: 100%"/>
        </a-form-item>
          </a-col>
        </a-row>
