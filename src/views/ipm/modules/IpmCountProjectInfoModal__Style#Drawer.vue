    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="项目信息" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="['project']" placeholder="请输入项目信息"></a-input>
        </a-form-item>
        ...
        <a-form-item label="离线数量" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input-number v-decorator="['unonlineCount']" placeholder="请输入离线数量" style="width: 100%"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ipm/ipmCountProjectInfo/add",
          edit: "/ipm/ipmCountProjectInfo/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'project','onlineCount','unonlineCount','onlineRate','createTime'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'project','onlineCount','unonlineCount','onlineRate','createTime'))
      }
