<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="IP地址">
              <a-input placeholder="请输入IP地址" v-model="queryParam.ip"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
          ...
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="负责人">
                <a-input placeholder="请输入负责人" v-model="queryParam.projectManager"></a-input>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="分配状态">
                <j-dict-select-tag placeholder="请选择分配状态" v-model="queryParam.usestatus" dictCode="useStatus"/>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="在线状态">
                <j-dict-select-tag placeholder="请选择在线状态" v-model="queryParam.onlineStatus" dictCode="onlineStatus"/>
              </a-form-item>
            </a-col>
            ...
            <a-col :xl="10" :lg="11" :md="12" :sm="24">
              <a-form-item label="上一次在线时间">
                <j-date :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择开始时间" class="query-group-cust" v-model="queryParam.lastOnlineTime_begin"></j-date>
                <span class="query-group-split-cust"></span>
                <j-date :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择结束时间" class="query-group-cust" v-model="queryParam.lastOnlineTime_end"></j-date>
              </a-form-item>
            </a-col>
            <a-col :xl="10" :lg="11" :md="12" :sm="24">
              <a-form-item label="检测时间">
                <j-date :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择开始时间" class="query-group-cust" v-model="queryParam.checkedTime_begin"></j-date>
                <span class="query-group-split-cust"></span>
                <j-date :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择结束时间" class="query-group-cust" v-model="queryParam.checkedTime_end"></j-date>
              </a-form-item>
            </a-col>
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="标签">
                <j-multi-select-tag placeholder="请选择标签" dictCode="tags" v-model="queryParam.tags"/>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('oss_ipm_ip_info')">导出</a-button>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        description: 'oss_ipm_ip_info管理页面',
        // 表头
        columns: [
          {
            title: '#',
        ...
        url: {
          ...
          delete: "/ipm/ipmIpInfo/delete",
          deleteBatch: "/ipm/ipmIpInfo/deleteBatch",
          exportXlsUrl: "/ipm/ipmIpInfo/exportXls",
          importExcelUrl: "ipm/ipmIpInfo/importExcel",
        },
        dictOptions:{},
      }
    },
